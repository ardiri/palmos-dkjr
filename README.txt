...
----------------------------------------------------------------------------
  ...
  Donkie Kung Jr. is designed for the Palm Computing Platform.  'dkjr.prc'
  ...
  Donkie Kung Jr can be installed and executed from flash memory! 

            http://www.ardiri.com/index.cfm?redir=palm&cat=dkjr
  ...
  you wish to play, or setup any configuration options.
  ...
  the key that locks the cage Donkie Kung is trapped in. You may configure
  the key and sound volume in the configuration screen. You get to this by
  selecting  the  menu  item  'Config'  in the  'Game' menu.  Consult your 
  handheld device manual for instructions of selecting a menu item. When a 
  game is active,  you may tap the speaker icon at the bottom left  of the 
  screen to get to the  configuration screen.  It is possible to pause the 
  current game in progress by tapping the paw icon.

  REGISTRATION:
  =============
 
  Donkie Kung  Jr is shareware,  the  demonstration version does not allow 
  the player  to generate high score  codes or the  ability to save Donkie 
  Kung more than once. To access  these  features, a device identification 
  number is required to generate a unique unlocking registration datafile.
  ...
  at the following web address:
     ...
     http://www.ardiri.com/index.cfm?redir=palm&cat=dkjr&subcat=survey
